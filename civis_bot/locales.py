...
TEXTS = {
    'en': {
        ...
        'subscribe_upgrade': "To upgrade, send /setkey to use your own OpenAI key, or send /support to contact developer.",
    ...
    'ru': {
        ...
        'subscribe_upgrade': "Чтобы перейти на платный тариф, отправьте /setkey со своим OpenAI ключом, или отправьте /support чтобы написать разработчику.",
